  ...
  return (
    <div className="h-full bg-[#F9FAFB] flex flex-col relative">
      ...
      <div className="flex-1 px-4 overflow-hidden">
        ...
        >
          <div
            className="absolute -top-1/2 -right-1/4 w-[140px] h-[140px] rounded-full"
            style={{
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-1.5 text-[11px] font-medium opacity-90 mb-2">
              <span className="w-2 h-2 bg-white rounded-full animate-pulse" />
              <span>Heads up</span>
            </div>

            <div className="flex items-baseline gap-1.5 mb-1">
              <span className="text-[56px] font-extrabold leading-none tracking-[-2px]">2</span>
              <span className="text-[18px] font-medium opacity-90">days</span>
            </div>
            <p className="text-[13px] opacity-85">until hard day</p>

            <div className="flex gap-2 mt-3">
              <div className="flex items-center gap-1.5 bg-white/20 px-2.5 py-1.5 rounded-full text-[11px] font-medium">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-[10px] font-semibold text-[#4B5563] border border-[#E5E7EB] px-2 py-1 rounded-full">
              84%
            </span>
          </div>
          ...
          <div className="flex justify-between items-end h-[70px]">
            {[
              ...
              <div key={item.day} className="flex flex-col items-center flex-1">
                <div className="h-[45px] flex items-end mb-1.5">
                  <div
