  ...
  return (
    <div className="h-full bg-[#F9FAFB] flex flex-col relative">
      ...
      <div className="flex-1 px-4 overflow-hidden">
        {/* Main Pattern Card */}
        <div className="bg-white rounded-xl p-4 shadow-sm mb-3 border-2 border-[#E11D48] relative overflow-hidden">
          {/* Top gradient bar */}
          <div
          ...
          <div className="flex items-center gap-2 mb-3">
            <span className="bg-[#E11D48] text-white text-[10px] font-semibold px-2.5 py-1 rounded-full">
              Discovery
            </span>
          ...
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-14 h-14 bg-[#CFFAFE] rounded-xl flex items-center justify-center">
                <svg className="w-7 h-7 text-[#0891B2]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
                </svg>
              </div>
              <span className="text-[10px] text-[#4B5563] font-medium">Poor sleep</span>
            </div>

            {/* Connector */}
            <div className="flex flex-col items-center gap-1">
              <span className="text-[18px] font-extrabold text-[#E11D48]">89%</span>
              <div
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-14 h-14 bg-[#FEE2E2] rounded-xl flex items-center justify-center">
                <svg className="w-7 h-7 text-[#E11D48]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M12 2c1 3 4 6 4 10a4 4 0 1 1-8 0c0-4 3-7 4-10z" />
                </svg>
              </div>
              <span className="text-[10px] text-[#4B5563] font-medium">Hot flashes</span>
            </div>
          </div>

          <p className="text-center text-[12px] font-semibold text-[#111827]">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            >
              <div className="text-[20px] font-extrabold text-[#111827] mb-1">{pattern.correlation}</div>
              <div className="text-[10px] text-[#9CA3AF] leading-tight">{pattern.description}</div>
              <div className="w-full h-[3px] bg-[#E5E7EB] rounded mt-2 overflow-hidden">
                <div
